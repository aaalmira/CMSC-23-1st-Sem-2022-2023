...
class _ShowDogsPageState extends State<ShowDogsPage> {
        ...
        onPressed: () {
          ...
          Navigator.of(context)
              .push(MaterialPageRoute(
                  builder: (context) =>
                      AddDogPage(title: 'Add Task', fileHandler: fileHandler)))
              .then((value) => setState(() {
                    myDogs = fileHandler.readFile();
                  }));
        },
  ...
  //Since readDogs method will return a Future list, we need a Future builder to build our list
      ...
      child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              //if textfile has no data, will only render circular progress indicator
              return const Center(
